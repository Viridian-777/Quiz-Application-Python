...
def populate():
    ...
    quiz_questions = [
        # Python Quiz
        (1, "What is the output of the following code: `print(type([]))`?", "<class 'list'>,<class 'tuple'>,<class 'set'>,<class 'dict'>", "<class 'list'>"),
    ...
    cursor.executemany("INSERT INTO quiz_questions (quiz_id, question, options, correct_answer) VALUES (?, ?, ?, ?)", quiz_questions)
